...
.data
	...
	szaTitle		db	"About keygen...", 0	
	
	szaText	db	13,13,13,13
		db  "      tHE   PERYFERiAH   tEAM   ",13
		db  "        pRESENTS nEW rLS ...    ",8
		db  13,13,13,13
		db  "   FairStars Audio Converter Pro ",13
		db  "            1.82 KeyGen          ",8
		db      13,13,13
		db  "  Cracker    : yMRAN            ",13
		db  "  Date       : 12.aug.2o22      ",13
		db  "  Protection : Custom           ",13
		db  "  Tune       : <early fall>     ",8
 		db	13,13
 		db	"  10x 2:                         ",13,13
		db  "   r0ger 4 CooL GFX              ",13
		db  "   Tangerine 4 Music             ",13
 		db	"   x0man 4 CooL About Template   ",8
 		
 		db  13,13,13,13
 		db  "   Canterwood 4 CooL Kgn Temp    ",13
 		db  "   LuoYunBin 4 CooL Water Effect ",8
 		
 		db	13,"  Greets 2:                      ",13,13
 		db	"  Al0hA.....................[PRF]  ",13
 		db	"  MaryNello.................[PRF]  ",13
